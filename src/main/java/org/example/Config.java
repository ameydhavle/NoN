...
public class Config extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        System.out.println("PermittedPatterns " + auth);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        System.out.println("PermittedPatterns " + getAlwaysPermittedPatterns());
        ...
        /*http.csrf()
            .ignoringAntMatchers("/nocsrf","/ext/cooc.xqy");*/
    }
    ...
    protected String[] getAlwaysPermittedPatterns() {
        return new String[] { "/ext/**", "/bower_components/**", "/fonts/**", "/images/**", "/styles/**" };
    }
